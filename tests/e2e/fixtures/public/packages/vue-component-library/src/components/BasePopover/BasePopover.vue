<template>
  ...
  >
    ...
    <div :class="popoverControlClasses" class="base-popover__control">
      <transition name="scale">
        ...
        >
          <slot :closePopover="closePopover" name="popover" />
        </base-card>
      </transition>
    </div>
  </div>
  ...
  computed: {
    popoverControlClasses() {
      return {
        ...
        'base-popover__control--align-top-center':
          this.alignment === 'top center',
        'base-popover__control--align-top-right':
          this.alignment === 'top right',
        'base-popover__control--align-right-top':
    ...
    popoverCardClasses() {
      return {
        'base-popover__container--padding-none':
          this.padding === 'none' || !this.padding,
        'base-popover__container--padding-extra-tight':
          this.padding === 'extra-tight',
        'base-popover__container--padding-tight': this.padding === 'tight',
        'base-popover__container--padding-base-tight':
          this.padding === 'base-tight',
        'base-popover__container--padding-base': this.padding === 'base',
        'base-popover__container--padding-loose': this.padding === 'loose',
        'base-popover__container--padding-extra-loose':
          this.padding === 'extra-loose'
      }
    }
  },
  methods: {
